...
namespace oa
{
    namespace nes
    {
        ...
        void R2A03::OpADC(AddressMethod addressMethod)
        {
            bool decimalMode = statusRegister_.decimalMode;
            statusRegister_.decimalMode = false;
            M6502::OpADC(addressMethod);
            statusRegister_.decimalMode = decimalMode;
        }
        
        void R2A03::OpSBC(AddressMethod addressMethod)
        {
            bool decimalMode = statusRegister_.decimalMode;
            statusRegister_.decimalMode = false;
            M6502::OpSBC(addressMethod);
            statusRegister_.decimalMode = decimalMode;
        }
